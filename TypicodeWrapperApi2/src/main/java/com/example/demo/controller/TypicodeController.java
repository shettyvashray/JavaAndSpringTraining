...
// METHODS FOR POSTS
	...
	public ResponseEntity<List<Posts>> getAllPostsWithComments() throws IOException {
		List<Posts> posts = client.getAllPostsWithComments();
		return new ResponseEntity<>(posts, HttpStatus.OK);
	}
...
// METHODS FOR ALBUMS
	...
	public ResponseEntity<List<Albums>> getAllAlbumsWithPhotos() throws IOException {
		List<Albums> albums = client.getAllAlbumsWithPhotos();
		return new ResponseEntity<>(albums, HttpStatus.OK);
	}
